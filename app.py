...
<div class="main-header">
    ...
    <p>Tác giả: Nông Thúy Hằng - Trường PTDTBT Tiểu học Kiên Đài - ĐT: 0963 314 963</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nông Thúy Hằng - Trường PTDTBT Tiểu học Kiên Đài - ĐT: 0963 314 962</div>", unsafe_allow_html=True)
